...
function Ring(radius, id){
  ...
  this.drawControl = function(){
    with(mgraphics){
      if(this.type == 0){ // sine (circle)
        ...
        move_to(this.ctrl_position.x,this.ctrl_position.y - 0.08);
  ...
  this.updateUI = function(active){
    if(active){
       this.live_osctype.activebgcolor(this.ctrl_on.r,this.ctrl_on.g,this.ctrl_on.b,1);
       this.live_oscamp.activebgcolor(this.ctrl_on.r,this.ctrl_on.g,this.ctrl_on.b,1);
       this.live_osctheta.activebgcolor(this.ctrl_on.r,this.ctrl_on.g,this.ctrl_on.b,1);
       this.live_oscamp.textcolor(0,0,0,1);
       this.live_osctheta.textcolor(0,0,0,1);
       this.live_osctype.textcolor(0,0,0,1);
    }else{
       this.live_oscamp.activebgcolor(0.2,0.2,0.2,1);
       this.live_osctheta.activebgcolor(0.2,0.2,0.2,1);
       this.live_osctype.activebgcolor(0.2,0.2,0.2,1);
       this.live_oscamp.textcolor(1,1,1,1);
       this.live_osctheta.textcolor(1,1,1,1);
       this.live_osctype.textcolor(1,1,1,1);
    }
  }
  ...
  this.checkParamsChanged = function(){
    ...
    if(this.type != this.live_osctype.getvalueof()){ //param changed
